...
<td><input type="text" name="user" placeholder="Enter user name" required="required"/ ></td>
<th colspan=2 align="center"><input type="submit" name="search" value="Search" ></th>
</tr>
...
if(isset($_POST['search'])){
	...
	if(mysqli_num_rows($run) <1){
		...
		while($data=mysqli_fetch_assoc($run)){
			...
			<td align="center"><a href="updateuser.php?sid=<?php echo $data['id'];?>"><button>Update</button></a></td>
             </tr>
